...
def pytest_addoption(parser):
    ...
    parser.addoption("--browser_name", default="chromium", help="Browser: chromium, firefox, webkit")
    parser.addoption("--headed_browser", action="store_true", help="Run in headed (visible) mode")
    parser.addoption("--base-url_new", default="https://opensource-demo.orangehrmlive.com/web/index.php/auth/login", help="Base URL for tests")
...
def browser_context(request):
    ...
    browser_name = get_config_value(request.config, "browser_name")
    headed_flag = get_config_value(request.config, "headed_browser")
